...
const QUESTS = [
  {
    ...
    desc: "Flutter wellness app for 11,000+ constituents — on-device YOLOv11 AI detection, gamification, and admin event management.",
  },
  {
    status: "DONE",
    ...
    desc: "Extended the Goanna rendering engine's CSS parser in a 100k+ line C++ production codebase.",
  },
  {
    status: "DONE",
    role: "Full Stack Developer",
    ...
    desc: "Shipped 2 internal web apps end-to-end — Next.js frontend and 10+ Express.js API endpoints.",
  },
  {
    status: "DONE",
    ...
    org: "CMSC 128 · UPLB",
    period: "Feb – Apr 2025",
    desc: "Led 4-person team across 10+ sprints building an alumni tracking system for the UPLB CS dept.",
  },
];
